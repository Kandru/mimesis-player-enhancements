...
| [Persistence](./features/persistence.md) | Keep mimic voice recordings when you save and load | Host only |
...
| [Loot Multiplicator](./features/loot-multiplicator.md) | More or less loot on the map and from enemy drops | Host only |
| [Economy](./features/economy.md) | Adjust starting cash, scrap value, shop prices, and currency retention | Host only |
| [Dungeon Time](./features/dungeon-time.md) | Extra shift time when you have more players | Host only |
...
| [Dungeon Randomizer](./features/dungeon-randomizer.md) | Randomize which dungeons appear and how they are laid out | Host only |
| [Weather](./features/weather.md) | Fixed, cycling, or vanilla weather plus synced start time for lighting | Host only |
