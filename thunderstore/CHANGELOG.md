...
## 26.8.1
- feature: Added "Savegame Preparation" to allow easy changes of the startup money and starting zone when creating a new savegame
...
- improvement: wiki is now shown in the sidebar (still AI generated content, will re-do once the bugs are squashed)
...
- fix: minimap had some smaller issues
...
- webinterface now shows changelog whenever the mod version changes to inform users
