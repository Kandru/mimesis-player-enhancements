...
public static class LootMultiplicatorPatches
{
    ...
    {
        public static MethodBase? TargetMethod() => ResolveExecuteLootingObjectSpawnMethod();
    ...
    {
        public static MethodBase? TargetMethod() => ResolveSpawnLootingObjectMethod();
    ...
    private static bool IsMapFixedLootSpawn(SpawnedActorData? spawnData) =>
        spawnData is FixedSpawnedActorData fixedSpawn
