    ...
    internal static class ReplaysPatches
    {
        ...
        private static void LogPatchAudit(HarmonyLib.Harmony harmony)
        {
            ...
            [
                ...
                ("OnGamePlaySceneLoadedComplete/ReplayManager", AccessTools.Method(typeof(ReplayManager), nameof(ReplayManager.OnGamePlaySceneLoadedComplete))),
                ...
                ("EndSceneLoading/GameMainBase", AccessTools.Method(typeof(GameMainBase), "EndSceneLoading")),
