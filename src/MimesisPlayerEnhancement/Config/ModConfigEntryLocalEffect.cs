    ...
    internal static class ModConfigEntryLocalEffect
    {
        ...
        private static readonly HashSet<(string SectionId, string Key)> LocalEntries =
            new(EntryKeyComparer.Instance)
            {
                ...
                (UiConfig.SectionId, "EnableLoadingWaitPlayerList"),
                ...
                (UiConfig.SectionId, "DiscoBallSoundMode"),
                (UiConfig.SectionId, "DiscoBallSoundVariant"),
                (UiConfig.SectionId, "DiscoBallSoundRandomPool"),
                (UiConfig.SectionId, "DiscoBallSoundVolume"),
