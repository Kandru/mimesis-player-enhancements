    ...
    internal static class ModConfigEntryUiHints
    {
        ...
        private static readonly Dictionary<(string SectionId, string Key), string[]> SelectValuesByEntry =
            new(EntryKeyComparer.Instance)
            {
                ...
                [(MimicTuningSectionId, "VoiceInitIntervalMode")] = ["Vanilla", "Random"],
                [(MimicTuningSectionId, "VoicePeriodicIntervalMode")] = ["Vanilla", "Random"],
                [(MimicTuningSectionId, "VoiceDeathMatchIntervalMode")] = ["Vanilla", "Random"],
                [(MimicTuningSectionId, "MimicTrustMode")] = ["Vanilla", "Custom"],
                [(MimicTuningSectionId, "TrustScoreValueMode")] = ["Vanilla", "Fixed", "Random"],
                [(MimicTuningSectionId, "MimicSocialMode")] = ["Vanilla", "Custom"],
                ...
                [(MimicTuningSectionId, "PossessionBtGateMode")] = ["Vanilla", "Always"],
