...
namespace MimesisPlayerEnhancement
{
    ...
    public static class ModConfig
    {
        ...
        public static MelonPreferences_Entry<string> AmbientMonsterWaveMode { get; internal set; } = null!;
        public static MelonPreferences_Entry<float> AmbientMonsterWaveInitialDelaySeconds { get; internal set; } = null!;
        public static MelonPreferences_Entry<float> AmbientMonsterWaveInitialDelayMinSeconds { get; internal set; } = null!;
        public static MelonPreferences_Entry<float> AmbientMonsterWaveInitialDelayMaxSeconds { get; internal set; } = null!;
        public static MelonPreferences_Entry<float> AmbientMonsterWaveIntervalSeconds { get; internal set; } = null!;
        public static MelonPreferences_Entry<float> AmbientMonsterWaveIntervalMinSeconds { get; internal set; } = null!;
        public static MelonPreferences_Entry<float> AmbientMonsterWaveIntervalMaxSeconds { get; internal set; } = null!;
